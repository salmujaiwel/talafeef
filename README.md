...
-	Standard--Academic النصوص الأكاديمية (A):	10,512 tokens.
-	Standard-- Khutbah خُطب الحرمين الشريفين (K):	10,380 tokens.
-	Standard--Journalism الصحف العربية (N): 10,408 tokens.
-	Standard--Official-Issues الإصدارات الرسمية: الأنظمة والتشريعات (O): 10,093 tokens.
-	Standard--Web نصوص الويب (W): 10,097 tokens. 
-
