...
* التنبؤ بالجمل العربية بما ليه من ضمن البيانات اللغوية المدربة.  
...
-	Standard--Official-Issues الأنظمة والتشريعات (O): 10,093 tokens (before tokenizing); 10,657 tokens (after tokenizing); 12,351 tokens (after segmenting)
